...
def main():
    ...
    even_better_draw_circles(rg.Point(0, 30), 20, 5, 'green', 7)
    even_better_draw_circles(rg.Point(20, 60), 35, 9, 'pink', 12)
    even_better_draw_circles(rg.Point(-30, -10), 11, 13, 'light blue', 3)
...
def better_draw_circles(rinc):
    ...
    for k in range(1, 10):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(rinc * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, rinc, num, color, thickness):
